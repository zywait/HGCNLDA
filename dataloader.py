...
class CVDataset(pl.LightningDataModule):
    ...
    def add_argparse_args(parent_parser):
        ...
        parser.add_argument("--global_test_all_zero", default=False, action="store_true", help="default:No Test")
        parser.add_argument("--train_fill_unknown", default=True, action="store_true", help="default:Drop")
    ...
    def fold_mask_iterator(self, interactions, mode="global", n_splits=10, row_idx=None, col_idx=None, global_test_all_zero=False, seed=666):
        ...
        if mode=="global":
            if n_splits==1:
                ...
                pos_row, pos_col = np.nonzero(interactions)     # pos_row
